                            ...
                            @foreach ($pengaduan->tanggapans as $t)
                                ...
                                <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        <p class="font-bold text-gray-900 text-sm">{{ $penulis->name }} <span class="text-xs text-gray-500 dark:text-gray-400 font-normal">{{ $t->petugas ? '(Petugas)' : '(Masyarakat)' }}</span></p>
                                    </div>
