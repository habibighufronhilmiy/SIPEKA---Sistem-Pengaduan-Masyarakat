<x-app-layout>
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900">📋 Daftar Pengaduan</h1>
        <p class="text-gray-500 text-sm mt-1">Semua laporan yang masuk dalam sistem</p>
    </div>
                ...
                <tbody>
                    @forelse ($pengaduans as $p)
                        <tr class="border-t border-gray-100 hover:bg-gray-50 transition">
                            ...
                            <td class="p-4">
                                <a href="{{ route('petugas.pengaduan.show', $p) }}" class="inline-flex items-center gap-1 text-primary-600 text-sm font-bold hover:text-primary-700">
                    ...
                    @empty
                        <tr><td colspan="6" class="p-10 text-center text-gray-400">Tidak ada pengaduan</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
